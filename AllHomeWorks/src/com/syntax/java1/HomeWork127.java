...
public class HomeWork127 {
	 ...
	 * 
	 * Returns: an integer Name: countA Parameters: a String called s Purpose: count
	 * the number of occurrences of 'a' or 'A' within s
	 * 
	 * Examples: countA("aaa") ==> 3 countA("aaBBdf8k3AAadnklA") ==> 6
	 * 
