...
public class HomeWork059 {

	public static void main(String[] args) {

		/*
		 * For you to do: Write a program that prints the string "Hey, it is year: " and
		 * the years between 2011 and 2019.
		 * 
	...
	int i =2011; 
	 ...
	 for (int a=2011; a<=2019;a++) {
		 ...
		 System.out.println("Hey it is a year : "+a);
		 i++;
